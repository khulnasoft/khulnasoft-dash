<template>
  ...
  >
    ...
    <v-text-field
      label="Khulnasoft Endpoint"
      name="khulnasoftApi"
      v-model="settings.khulnasoftApi"
      outlined
      prepend-inner-icon="mdi-api"
      hint="http://khulnasoft.console"
      dense
    >
    </v-text-field>
    <v-text-field
    ...
    <v-text-field
      ...
      hint="Khulnasoft console username"
      outlined
    ...
    <v-text-field
      ...
      hint="Khulnasoft console password"
  ...
  import {mapActions} from 'vuex'
	export default {
      ...
      rememberMeText: 'Remember me for 30 days'
		...
		created: function () {
			this.settings.khulnasoftApi = this.$store.getters.khulnasoftApi
